...
\begin{figure}[h!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{LLM: centroid distance vs.\ logit margin for MPNet-FT-Final
             ($r\!=\!0.988$). Geometric position almost perfectly determines
             classifier confidence.}
    \label{fig:dist-logit}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.52\textwidth}
    \includegraphics[width=\textwidth]{Uncertainity_report_brain_data}
  ...
  \caption{\textbf{Geometric predictors of confidence (Finding 4).}
           (a) In LLMs, centroid distance tightly predicts logit confidence.
...
of the functional form (Figure~\ref{fig:brain-uncertainty}).

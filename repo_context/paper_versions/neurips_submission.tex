...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.44\textwidth}
    ...
    \caption{Radial density decay for LLM variants (coloured) overlaid with
             human brain fMRI (dashed black).
             The two-zone structure extends to neural data.}
    \label{fig:brain-density}
  \end{subfigure}
  \caption{\textbf{The Void and the Belt (Finding 1).}
           (a) All 8 LLM variants share the same two-zone radial density
           structure in normalised-distance space.
           (b) The same structure is present in human brain fMRI emotion
           representations, establishing it as a cross-system geometric
           principle.}

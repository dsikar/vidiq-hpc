...
\begin{figure}[h!]
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \includegraphics[height=3.2cm]{comparison_scatter_BGE-Base-Final}
  ...
  \hfill
  \begin{subfigure}[t]{0.49\textwidth}
    \includegraphics[height=3.2cm]{comparison_scatter_MPNet-Base-Final}
    \caption{MPNet-Base-Final: same comparison. Silhouette improves from
             0.057 to 0.415 ($+627\%$) and from 0.047 to 0.408 ($+765\%$).}

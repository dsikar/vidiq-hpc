...
Qwen-FT~\citep{qwen2025} ($D_{50}\!=\!12$, AUC 0.260) compresses signal into a steep
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[t]{0.51\textwidth}
    \includegraphics[height=3cm]{early_decay_comparison_top25}
  ...
  \begin{subfigure}[t]{0.47\textwidth}
    \includegraphics[height=3cm]{Content_Retention_Comparison_}
